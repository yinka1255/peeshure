...
<head>
	...
	<title>Photomace Admin Panel | Products</title>
			...
			<div class="box-content">
				...
				<table id="example" class="table table-striped table-bordered display" style="width:100%;">
					...
					<tbody>
						...
						<tr>
							<td>{{$key + 1}}</td>
							<td><img src="{{asset('public/images/products/'.$product->image)}}" width="50px" height="auto"  /> </td>
							<td>{{$product->name}}</td>
							<td>{{$product->type}}</td>
		...
		<div class="modal-content" style="padding-bottom: 20px;">
			...
			<div class="modal-body">
				<div style="width: 100%;margin: 0 auto;text-align:center;">
					<img style="height:200px;width: auto;text-align: center;" id="image" />
				</div>
				<form action="{{url('admin/edit_product')}}" method="post" class="">
					<br/>
					...
					<div class="form-group">
						<label>Tags</label>
						<input type="text" data-role="tagsinput" name="tags" id="edit_tags" required class="form-control" />
					</div>
