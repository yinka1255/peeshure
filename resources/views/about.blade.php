...
<head>
    ...
    -->
    <meta charset="UTF-8">
    <title>Shephered Insurance Brokers Nigeria | About</title>
...
<body>
    ...
    <div class="heading-page heading-page-1 heading-page-2">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li>
                    <a href="blog-single.html">Overview Company</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-9">
                    <section class="section post-section-1 m-b-30 p-r-15">
                        ...
                        data-carousel-autoplay="true">
                            <img class="img-responsive" src="{{asset('public/main/images/about-post-01.jpg')}}" alt="Post Image">
                            {{--<img class="img-responsive" src="{{asset('public/main/images/about-post-02.jpg')}}" alt="Post Image">
                            <img class="img-responsive" src="{{asset('public/main/images/services-04.jpg')}}" alt="Post Image">--}}
                        </div>
                        <div class="post-content">
                            <h4 class="text-block text-bold text-black text-med-large m-b-20">Who We Are</h4>
                            <p class="text-block m-b-30">
                                Duis nunc tortor, condimentum porta leo id, tempus mollis nulla. Suspendisse blandit congue rutrum. Proin nec porttitor arcu. Etiam a dictum odio. Vivamus massa purus, dignissim vitae volutpat ac, fringilla in orci. Nulla faecenas blandit bibendum laoreet.
                                Nam justo arcu, tempor eu dolor nec, suscipit laoreet odio. Donec mattis est eget sem euismod, in cursus massa ullamcorper.
                            </p>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <h4 class="text-block text-bold text-black text-med-sm m-b-20">IT Our Mission</h4>
                                    <p class="text-block">
                                        Morbi eros augue, euismod non posuere vel, accumsan at nulla. Mauris sit amet tempus orci. Sed vel bibendum urna, in blandit nunc. Praesent eget mauris auctor, efficitur justo sed, consectetur dolor. Cras aliquet mi vitae convallis luctus. Aenean imperdiet
                                        mi et eleifend efficitur.
                                    </p>
                                </div>
                                <div class="col-md-6 js-waypoint">
                                    <h4 class="text-block text-bold text-black text-med-sm m-b-20">How We Work With You</h4>
                                    <p class="text-block m-b-30">
                ...
                <div class="col-md-3">
                    <div class="banner-contact m-b-50">
                        ...
                        <p class="m-b-20">To discuss how our team can help your business achieve true results, please</p>
                        <a class="au-btn au-btn-border au-btn-border-light au-btn-block" href="{{url('contact')}}">Contact Us</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section bg-primary p-t-25 p-b-25 cta-section-1 cta-section-2">
        <div class="container">
            ...
            <div class="block-right">
                <a class="au-btn au-btn-border au-btn-border-light" href="{{url('contact')}}">Get A Free Quote</a>
            </div>
        </div>
    </div>
    <!-- call to action / end-->
