...
<head>
	...
	<!-- Title Of Site -->
	<title>Photomace | Privacy policy</title>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-12 col-md-12">
							<h3>Privacy</h3>
							<p style="text-align: justify;">The following information is to help you understand how we collect, use, disseminate and safeguard the data you provide while accessing and using Photomace.
							</p>
							<b>Personal information?</b>
							<p>You may provide certain personal information, such as your first and last name, the country you live in, PayPal (or any other available payment platform) address, and email address, which will be displayed on your public profile page on Photomace.
							...
							<b>Cookies</b>
							<p>A cookie is a small file containing a string of characters that is sent to your computer when you visit a website. When you visit the website again, the cookie allows that site to recognize your browser. Cookies are used on Photomace to store visitor preferences and other technical information required for the functionality of the Website. No personal information is stored in these cookies. You can reset your browser to refuse all cookies or to indicate when a cookie is being sent. However, some website features or services may not function properly without cookies.
								</p>
							<b>Persons under 16</b>
							<p>Photomace is not marketed toward persons under the age of 16. If we discover that personal information was inadvertently collected about individuals under the age 16, we will promptly delete such information.</p>
